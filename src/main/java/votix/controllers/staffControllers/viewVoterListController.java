...
//code needs to be edited to load voters from database
import java.net.URL;
...
public class viewVoterListController {
    ...
    @FXML
    void initialize() {
        assert voterTable != null : "fx:id=\"candidateTable\" was not injected: check your FXML file 'CandidateList.fxml'.";
    ...
    private void populateVoters() {
        if (ems != null) {
            System.out.println("EMS is not null, loading voter...");
